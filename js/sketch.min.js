    ...
    function s(e) {
        ...
        function r() {
            I(A),
                ...
                e.running &&
                    !q &&
                    ((e.dt = (z = +new Date()) - e.now), (e.millis += e.dt), (e.now = z), t(e.update), Z && (e.retina && (e.save(), e.autoclear && e.scale(V, V)), e.autoclear && e.clear()), t(e.draw), Z && e.retina && e.restore()),
                (q = ++q % e.interval);
        }
        function c() {
            (S = J ? e.style : e.canvas),
                ...
                (Y = e.width),
                (j = e.height),
                e.fullscreen && ((j = e.height = v.innerHeight), (Y = e.width = v.innerWidth)),
                e.retina && Z && V && ((S.style.height = j + "px"), (S.style.width = Y + "px"), (Y *= V), (j *= V)),
        ...
        function d(e) {
            if ((e.preventDefault(), (G = l(e)), (G.originalEvent = e), G.touches)) for (Q.length = G.touches.length, _ = 0; _ < G.touches.length; _++) Q[_] = f(G.touches[_], Q[_]);
            else (Q.length = 0), (Q[0] = f(G, $));
            return a($, Q[0], !0), G;
        }
        function p(n) {
            for (n = d(n), M = (X = ee.indexOf((W = n.type))) - 1, e.dragging = !!/down|start/.test(W) || (!/up|end/.test(W) && e.dragging); M; ) i(ee[M]) ? t(e[ee[M--]], n) : i(ee[X]) ? t(e[ee[X++]], n) : (M = 0);
        }
        function g(n) {
        ...
        var A,
            ...
            ee = [e.eventTarget || e.element, p, "mousedown", "touchstart", p, "mousemove", "touchmove", p, "mouseup", "touchend", p, "click", p, "mouseout", p, "mouseover", x, g, "keydown", "keyup", v, m, "focus", "blur", c, "resize"],
            te = {};
        for (F in C) te[C[F]] = !1;
        return a(e, { touches: Q, mouse: $, keys: te, dragging: !1, running: !1, millis: 0, now: NaN, dt: NaN, destroy: T, toggle: k, clear: P, start: y, stop: E }), b.push(e), e.autostart && y(), n(!0), c(), r(), e;
    }
    for (
        var f,
            d,
            p = "E LN10 LN2 LOG2E LOG10E PI SQRT1_2 SQRT2 abs acos asin atan ceil cos exp floor log round sin sqrt tan atan2 pow max min".split(" "),
            g = "__hasSketch",
            m = Math,
            h = "canvas",
            y = "webgl",
            ...
            v = e,
            b = [],
            E = { fullscreen: !0, autostart: !0, autoclear: !0, autopause: !0, container: x.body, interval: 1, globals: !0, retina: !1, type: h },
            C = { 8: "BACKSPACE", 9: "TAB", 13: "ENTER", 16: "SHIFT", 27: "ESCAPE", 32: "SPACE", 37: "LEFT", 38: "UP", 39: "RIGHT", 40: "DOWN" },
            k = {
                CANVAS: h,
                WEB_GL: y,
                WEBGL: y,
                ...
                create: function (e) {
                    return (
                        ...
                        (f = e.element = e.element || x.createElement(e.type === w ? "div" : "canvas")),
                        (d = e.context =
                            e.context ||
                            (function () {
                                switch (e.type) {
                ...
                augment: function (e, t) {
                    return (t = a(t || {}, E)), (t.element = e.canvas || e), (t.element.className += " sketch"), a(e, t, !0), s(e);
                },
            },
            P = ["ms", "moz", "webkit", "o"],
            T = self,
